    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('money', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14, validators=[djmoney.models.validators.MinMoneyValidator(Decimal('0')), djmoney.models.validators.MaxMoneyValidator(Decimal('9999.989999999999781721271574497222900390625'))])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='values', to='products.property')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='products.propertyvalue'),
        ),
        migrations.CreateModel(
            name='Discount',
            fields=[
